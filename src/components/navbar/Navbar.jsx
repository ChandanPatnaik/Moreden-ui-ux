  ...
  return (
    <div className="gpt3__navbar">
      ...
      <div className="gpt3__navbar__menu">
        {toggleMenu ? (
          <RiCloseLine className="react-open-close-button" color="#fff" size={27} onClick={() => setToggleMenu(false)}/>)
           : (<RiMenu3Line className="react-open-close-button" color="#fff" size={27} onClick={() => setToggleMenu(true)}/>
        ) }
        {toggleMenu && (
